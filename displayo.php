...
$sql = "select * from (SELECT *FROM abstractsub ORDER BY year desc) T where Branch='electronics'";
...
<!--Navigation bar -->
  ...
  <div class="block">
    <div class="carousel carousel-slider">
      <a class="carousel-item" href="#"><img src="media/o1.jpg"></a>
      <a class="carousel-item" href="#"><img src="media/o2.jpg"></a>
      <a class="carousel-item" href="#"><img src="media/o3.jpg"></a>
    </div>
  </div>
